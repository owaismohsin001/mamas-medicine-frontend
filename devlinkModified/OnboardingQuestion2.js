...
import _styles from "../devlink/OnboardingQuestion2.module.css";
...
export function OnboardingQuestion2({
  as: _Component = _Builtin.Block,
  text1 = "Q1 of 4",
  text2 = "When you think about your relationship with your child overall, how does it feel most of the time?",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "progress_bar-step1")}
                tag="div"
              />
            </_Builtin.Block>
          </_Builtin.Block>
            ...
            >
              ...
              >
                ...
                <_Builtin.FormRadioWrapper
                  ...
                  data-w-id="3eb1f1d9-95aa-5313-032d-1b88756a82b6"
                  id="parent_climate"
                >
                  <_Builtin.Block
                  ...
                  <_Builtin.FormRadioInput
                    ...
                    type="radio"
                    name="Step1"
                    value="Mostly easy and enjoyable"
                    data-name="Step1"
                    required={false}
                    form={{
                      type: "radio-input",
                  ...
                  >
                    {"Mostly easy and enjoyable"}
                  </_Builtin.FormInlineLabel>
                </_Builtin.FormRadioWrapper>
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="3eb1f1d9-95aa-5313-032d-1b88756a82bc"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
                  ...
                  <_Builtin.FormRadioInput
                    ...
                    type="radio"
                    name="Step1"
                    value="A mix of easy moments and hard moments"
                    data-name="Step1"
                    required={false}
                    form={{
                      type: "radio-input",
                  ...
                  <_Builtin.FormInlineLabel
                    className={_utils.cx(_styles, "reflection_bnt-label")}
                  >
                    {"A mix of easy moments and hard moments"}
                  </_Builtin.FormInlineLabel>
                </_Builtin.FormRadioWrapper>
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="3eb1f1d9-95aa-5313-032d-1b88756a82c2"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
                  ...
                  <_Builtin.FormRadioInput
                    ...
                    type="radio"
                    name="Step1"
                    value="Often intense or emotionally heavy"
                    data-name="Step1"
                    required={false}
                    form={{
                      type: "radio-input",
                  ...
                  <_Builtin.FormInlineLabel
                    className={_utils.cx(_styles, "reflection_bnt-label")}
                  >
                    {"Often intense or emotionally heavy"}
                  </_Builtin.FormInlineLabel>
                </_Builtin.FormRadioWrapper>
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="3eb1f1d9-95aa-5313-032d-1b88756a82c8"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
                  ...
                  <_Builtin.FormInlineLabel
                    className={_utils.cx(_styles, "reflection_bnt-label")}
                  >
                    {"Quiet, gentle, and steady"}
                  </_Builtin.FormInlineLabel>
                </_Builtin.FormRadioWrapper>
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="3eb1f1d9-95aa-5313-032d-1b88756a82ce"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
                  ...
                  <_Builtin.FormRadioInput
                    ...
                    type="radio"
                    name="Step1"
                    value="It changes a lot depending on what’s going on"
                    data-name="Step1"
                    required={false}
                    form={{
                      type: "radio-input",
                ...
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="3eb1f1d9-95aa-5313-032d-1b88756a82d4"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
                  ...
                  <_Builtin.FormRadioInput
                    ...
                    type="radio"
                    name="Step1"
                    value="Distant or hard to connect"
                    data-name="Step1"
                    required={false}
                    form={{
                      type: "radio-input",
        ...
        >
          <_Builtin.Link
            ...
            button={false}
            id="onboarding_reflection_2_back_btn"
            block="inline"
            options={link1}
          >
            <_Builtin.Block
          ...
          <_Builtin.Link
            ...
            button={true}
            id="onboarding_reflection_2_btn"
            block=""
            options={link2}
          >
            {text4}
