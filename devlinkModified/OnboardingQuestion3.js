...
import _styles from "../devlink/OnboardingQuestion3.module.css";
...
export function OnboardingQuestion3({
  as: _Component = _Builtin.Block,
  text1 = "Q2 of 4",
  text2 = "Does your child tend to stir strong emotions in you?",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "progress_bar-step2")}
                tag="div"
              />
            </_Builtin.Block>
          </_Builtin.Block>
            ...
            >
              ...
              >
                ...
                <_Builtin.FormRadioWrapper
                  ...
                  data-w-id="0cc645c0-da32-16d3-3b25-09320588e6db"
                >
                  <_Builtin.Block
                  ...
                  >
                    {"Yes - they know how to push my buttons"}
                  </_Builtin.FormInlineLabel>
                </_Builtin.FormRadioWrapper>
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="0cc645c0-da32-16d3-3b25-09320588e6e1"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
                ...
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="0cc645c0-da32-16d3-3b25-09320588e6e7"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
                  ...
                  <_Builtin.FormInlineLabel
                    className={_utils.cx(_styles, "reflection_bnt-label")}
                  >
                    {"Rarely - our bond feels steady"}
                  </_Builtin.FormInlineLabel>
                </_Builtin.FormRadioWrapper>
                <_Builtin.FormRadioWrapper
                  className={_utils.cx(_styles, "reflection_radio-fild")}
                  data-w-id="0cc645c0-da32-16d3-3b25-09320588e6ed"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "dot_first")}
                    tag="div"
        ...
        >
          <_Builtin.Link
            ...
            button={false}
            id="onboarding_reflection_3_back_btn"
            block="inline"
            options={link1}
          >
            <_Builtin.Block
          ...
          <_Builtin.Link
            ...
            button={true}
            id="onboarding_reflection_3_btn"
            block=""
            options={link2}
          >
            {text4}
