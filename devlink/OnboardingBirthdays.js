...
import _styles from "./OnboardingBirthdays.module.css";
                  ...
                  >
                    ...
                    >
                      <_Builtin.FormTextInput
                        ...
                        name="parent_birth_place"
                        maxLength={256}
                        data-name="parent_birth_place"
                    ...
                    >
                      <_Builtin.FormTextInput
                        ...
                        required={true}
                        autoFocus={false}
                        id="parent_birth_place"
                      />
                      <_Builtin.Block
                        className={_utils.cx(_styles, "suggestions")}
                        tag="div"
                        aria-label="Birthplace suggestions"
                        id="parent_birth_place_suggestions"
                      >
                        <_Builtin.Block
                          className={_utils.cx(_styles, "suggestion-item")}
                          tag="div"
                        />
                        <_Builtin.Block
                          className={_utils.cx(_styles, "suggestion-empty")}
                          tag="div"
                        />
                      </_Builtin.Block>
                    </_Builtin.Block>
